...
public class Task8 {
    ...
    public static void main(String[] args) throws Exception {
        readDataFromFile("src/main/resources/Task8/input.txt");
        ...
        writeResultInFile("src/main/resources/Task8/output.txt");
    }
    ...
    private static void readDataFromFile(String filename) throws FileNotFoundException {
        ...
        for (int i = 0; i < edgesCount; i++) {
            ...
            graph[inputVertex].getOutVertices().put(graph[outputVertex], 1);
            graph[outputVertex].getOutVertices().put(graph[inputVertex], 1);
        }
